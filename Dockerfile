...
RUN apt-get install -y wget curl git tmux imagemagick htop libsndfile1 nfs-common unzip cmake libgl1 python3-opencv sudo g++ build-essential libopenblas-dev
